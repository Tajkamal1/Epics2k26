...
const TeamSection = () => {
  ...
  const groupedMembers = {
    'HOD Cybersecurity': teamMembers.filter(
      member => member.position === 'Head of the Department'
    ),

    'Faculty Coordinators': teamMembers.filter(
      member => member.position === 'Faculty Coordinator'
    ),

    'Student Coordinators': teamMembers.filter(
      member =>
        member.position === 'Student Coordinator' ||
  ...
  return (
    <section id="team" className="relative py-24 sm:py-32 overflow-hidden" ref={ref}>
      <div className="container relative z-10 px-6">
        ...
        {/* Student Coordinators - NO DESCRIPTION */}
        <div>
          <h3 className="font-orbitron text-2xl font-bold text-primary mb-8 text-center">
